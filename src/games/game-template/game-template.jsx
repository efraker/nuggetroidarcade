...
const GAME_CONFIG = {
  ...
  title: "My Amazing Quiz", // TODO: Replace with your game's title
  emoji: "🎮", // TODO: Choose an emoji for your game
  theme: "adventure", // TODO: Choose theme: adventure, space, ancient, pirate, etc.
  
  // Scoring settings - adjust these to make your game easier or harder
  pointsPerCorrect: 100,
  
  // Visual settings
  primaryColor: "indigo", // Options: indigo, green, blue, purple, red, yellow
  accentColor: "green"
};

// SEMANTIC CUE: These are the available categories in your game data
// Claude can easily add new categories by expanding templateData
const AVAILABLE_CATEGORIES = Object.keys(templateData || {});
...
export default function GameTemplate() {
  ...
  const startGame = () => {
    ...
    const categoryQuestions = safeDataAccess.getQuizQuestions(templateData, selectedCategory, GAME_CONFIG.title);
      ...
      <div className="max-w-4xl mx-auto p-4" style={{ fontFamily: "'Press Start 2P', cursive" }}>
        ...
        <div className="p-8 rounded-lg bg-red-900/20 border-2 border-red-500 text-white text-center">
          ...
          <p className="text-sm text-gray-300 mb-4">
            💡 Fix the issues above in your template-data.js file and refresh the page!
          </p>
          <button 
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4 mb-6 flex-wrap">
              {AVAILABLE_CATEGORIES.map(category => {
                const questionCount = templateData[category]?.length || 0;
                return (
                  <button
                    key={category}
